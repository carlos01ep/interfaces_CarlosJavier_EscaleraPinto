...
public class DateUtil {
	...
	/** Patr�n empleado para convertir fechas */
	...
	/**
     * Devuelve la fecha que llega como par�metro como un string formateado
     * 
     ...
     * 
     * Devuelve null si el formato es incorrecto y no se puede realizar la conversi�n
     * 
